...
def submit_form():
    ...
    if action == 'select_pdf':
        # Code to handle selecting PDF format
        return "Selected PDF format"
    elif action == 'upload':
        # Code to handle uploading file
        return "Uploaded file"
    elif action == 'submit':
        # Code to handle submitting the form
        # Execute your Python script or function here
...
# Example usage
    ...
    return "Congratulations! You've been shortlisted for the position.Dear Candidate,\n\nCongratulations! We are hereby inform you  that you have been shortlisted for the position based on your impressive resume.\n\nBest regards,\nThe Hiring Team"
